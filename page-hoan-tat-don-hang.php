    ...
    <div id="colLeftNoBorder" class="col-md-8 sidebar-separator">
        ...
        <div id="mainDisplay">
            <div class="confirmbox">
                ...
                <h3 style="margin-bottom: 5px;">Mã đơn hàng (MDH) của bạn là : <b style="font-size:25px;color:#F20000;font-weight:bold;"><?php echo  $result['name'] ?></b></h3>
                <div>
                   <p style="text-align: justify; margin: 5px 0;">
                    Cám ơn bạn đã đặt vé tại VMB Nam Phương, Booker sẽ liên hệ bạn trong thời gian sớm nhất để xác thực thông tin đăng ký và giá vé của thời điểm xử lý.
                      ...
                      <p style="text-align: justify; margin: 5px 0;">
                   Sau quá trình xác nhận này quý khách cần chuyển khoản thanh toán để bảo vệ giá. Sau khi chuyển khoản xin vui lòng nhắn tin vào số  <span style="font-weight: bold; color:#FE5815">091 30 30 802</span> kèm theo thông tin mã đơn hàng, tên người liên hệ.
                   <br /> Hoặc gọi vào đây để báo có :  <span style="font-weight: bold; color:#FE5815; font-size:18px;"><strong><?php echo get_option('opt_hotline'); ?></strong> - <strong><?php echo get_option('opt_hotline2'); ?></strong> - <strong><?php echo get_option('opt_phone'); ?></strong></span>.
          ...
          <!--End car rental-content-->
            ...
            <div id="pagecontent">
                <table id="printit" width="98%" style="margin-bottom: 10px;">
                    <tr>
                        <td width="80%"><h2 style="font-size: 18px;">CHI TIẾT ĐƠN HÀNG SỐ : <?php echo  $result['name'] ?> </h2></td>
                        <td style="text-align: right;font-size: 12px;">&nbsp;</td>
                    </tr>
                </table>
                <div id="printarea">
                    <a href="javascript:window.print()" id="btnprint">Print</a>
                    <?php
                    if($result['ticket_type'] == 2)
                    { #CHUYEN QUOC TE
                        ?>
                        <table class="field-table">
                            <tr>
                                <td>Mã số (Booking):</td><td><strong><?php echo  $result['name'] ?></strong></td>
                                <td>Trạng thái:</td><td><strong>Chưa xác nhận</strong></td>
                            </tr>
                            <tr>
                                <td width="15%">Chuyến bay:</td><td><strong><?php echo  $way_flight_text ?></strong></td>
                       ...
                       echo '</pre>';*/
                        ...
                        <table class="field-table">
                            ...
                            <tr>
                                ...
                                <td><b><?php echo  $dep_source ?></b><p><?php echo  $depart_date ?>, <b><?php echo  $dep_deptime ?></b></p></td>
                                <td><b><?php echo  $dep_destination ?></b><p><?php echo  $arv_date ?>, <b><?php echo  $dep_arvtime ?></b></p></td>
                        ...
                        endforeach;
                            ...
                            <?php foreach($ret_int as $ht):
                                ...
                                <tr>
                                    <td class="logo"><img src="<?php echo  $dep_logo ?>"/> </td>
                                    <td><b><?php echo  $ret_source ?></b><p style="font-size:11px;"><?php echo  $return_date ?>, <b><?php echo  $ret_deptime ?></b></p></td>
                                    <td><b><?php echo  $ret_destination ?></b><p style="font-size:11px;"><?php echo  $arv_date ?>, <b><?php echo  $ret_arvtime ?></b></p></td>
                                    <td><?php echo  $ht['airline_name'] ?> <br/>
                        ...
                        <table class="field-table" width="100%" cellpadding="0" cellspacing="0" border="0">
                            <tr>
                                ...
                                <td width="30%"><strong><?php echo  $result['name'] ?></strong></td>
                        ...
                        <table class="field-table" width="100%" cellpadding="0" cellspacing="0" border="0">
                            ...
                            <tr>
                                ...
                                <td><b><?php echo  $GLOBALS['CODECITY'][$dep_source] ?> (<?php echo  $dep_source ?>)</b><p style="font-size:11px;"><b><?php echo  $dep_deptime ?></b>, <?php echo  $depart_date ?></p></td>
                                <td><b><?php echo  $GLOBALS['CODECITY'][$dep_destination] ?> (<?php echo  $dep_destination ?>)</b><p style="font-size:11px;"><b><?php echo  $dep_arvtime ?></b>, <?php echo  $depart_date ?></p></td>
                            ...
                            <tr>
                                ...
                                <td><b><?php echo  $GLOBALS['CODECITY'][$ret_source] ?> (<?php echo  $ret_source ?>)</b><p style="font-size:11px;"><b><?php echo  $ret_deptime ?></b>, <?php echo  $return_date ?></p></td>
                                <td><b><?php echo  $GLOBALS['CODECITY'][$ret_destination] ?> (<?php echo  $ret_destination ?>)</b><p style="font-size:11px;"><b><?php echo  $ret_arvtime ?></b>, <?php echo  $return_date ?></p></td>
                ...
                <div class="confirm_info">
                    ...
                    <span style="font-weight:bold;color:#FE5815; font-size: 22px; line-height: 200%;"> <?php echo get_option('opt_hotline'); ?></strong> - <strong><?php echo get_option('opt_hotline2'); ?></strong> - <strong><?php echo get_option('opt_phone'); ?></strong></span> <br />
                    
                     Hoặc có thể gởi mail vào <strong><?php echo get_option('opt_contactemail'); ?></strong> bao gồm thông tin mã đơn hàng, tên người liên hệ. Trong thời gian 30p nếu chưa nhận được phản hồi, xin gọi đến tổng đài để xác nhận.
                    </p>
                    <br/>
                </div><!-- .confirm_info -->
