...
<div class="passsenger">
    ...
    <div class="field-table" width="100%">
        <div class="row">
             <div class="col-md-4 col-sm-6 col-xs-12"><label>Chuyến bay :  
            <strong><?= $GLOBALS['way_flight_list'][$_SESSION['search']['way_flight']] ?></strong></label></div>
            <div class="col-md-8 col-sm-6 col-xs-12"><label>Số lượng :  
    ...
    <div class="field-table" width="100%">
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-3 col-xs-6"><b><?= $GLOBALS['CODECITY'][$source] ?> (<?= $source ?>)</b><p ><?= $depart ?>, <b><?= $dep_deptime ?></b></p></div>
            <div class="col-md-3 col-sm-3 col-xs-6"><b><?= $GLOBALS['CODECITY'][$destination] ?> (<?= $destination ?>)</b><p ><?= $depart ?>, <b><?= $dep_arvtime ?></b></p></div>
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-3 col-xs-6"><b><?= $GLOBALS['CODECITY'][$destination] ?> (<?= $destination ?>)</b><p><?= $return ?>, <b><?= $ret_deptime ?></b></p>
            </div>
...
<div>
    ...
    <div class="field-table">
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-8 col-xs-8">
            	<div class="form-group"> 
                <label>Họ và tên <?php echo $need; ?></label> 
    ...
    <table class="field-table">
        ...
        <?php Dep_addBaggage($dep_airline);?>
        <tr>
        ...
        <?php Ret_addBaggage($ret_airline);?>
        <? } ?>
    </table>
</div>
    <?
...
<!--THÔNG TIN LIÊN HỆ-->	
    ...
    <p style="margin:0 0 5px 0px;">(<?= $need ?>) Vui lòng cung cấp đầy đủ và chính xác thông tin của bạn. Mọi sai sót đều mất phí khi thay đổi lại !!</p>
    <div class="field-table">
	...
	<div class="field-table">
            <div><textarea name="special_request"  class="form-control" rows="5"></textarea></div>
              <button type="submit" id="sm_bookingflight" name="sm_bookingflight" class="button mt30 pull-right"> Tiếp tục</button>
        ...
        <div class="widgetblock-content">
				...
				<div class="composite-heading  clearfix">
				 ...
				 <table class="field-table">
                    ...
                    <tr>
                        ...
                        <td colspan="3" style="text-align: right;"><b><?php $total_price = $total_adults + $total_child + $total_inf + $total_tax_adults + $total_tax_child + $total_tax_inf; echo format_price($total_price);?></b></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="5" style="border-top:1px solid #DDD;text-align: right">
                            <p style="color:#777;font-size:11px;padding: 5px 0;">Lượt đi tổng cộng</p>
                            <strong style="font-size:15px;"><span id="dep_total"><?php echo  format_price_nocrc($total_price)?></span> VND</strong>
            ...
            <fieldset>
                ...
                <table class="field-table">
                    ...
                    <tr>
                        <td colspan="2">Tổng giá</td>
                        <td colspan="3" style="text-align: right;"><b><?php $total_price_ret = $total_adults_ret + $total_child_ret + $total_inf_ret + $total_tax_adults_ret + $total_tax_child_ret + $total_tax_inf_ret; echo format_price($total_price_ret);?></b></td>
                    </tr>
                    <tr>
                        <td colspan="2">Hành lý thêm</td>
                    ...
                    <tr>
                        <td colspan="5" style="border-top:1px solid #DDD;text-align: right;">
                            <p style="color:#777;font-size:11px;padding: 5px 0;">Lượt về tổng cộng</p>
                            <strong style="font-size:15px;"><span id="ret_total"><?php echo  format_price_nocrc($total_price_ret) ?></span> VND</strong>
