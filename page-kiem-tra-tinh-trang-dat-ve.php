...
<div class="row"> <div class="block">
	   ...
	   <div id="mainDisplay" class="single">
            ...
            <?php  else : ?>
                ...
                <!-- END #editor-area -->
                <p>Booking vé máy bay, check-in online. Bạn hãy nhập email hoặc số điện thoại kèm theo mã đơn hàng (booking). Hệ thống sẽ giúp bạn tra cứu vé của <strong>Vietjet, Jetstar và Vietnam Airlines</strong>. Liên hệ booker để được trợ giúp : (08) 6650 9900 – 0123 900 1886 – 091 30 30 802.</p>
